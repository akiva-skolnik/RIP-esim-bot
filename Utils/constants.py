...
# import requests
# api_countries = requests.get("https://mira.e-sim.org/apiCountries.html", verify=False).json()
...
gids = {  # server: (sheet id, time gid, buffs gid)
    ...
    "mira": ("1-9GS8qk8mnAIb9oLrP67OsJBHefMqEanV0xmUZz5dk0", 1445005647, 1812695346),
    "oria": ("10AWTrM5gSLPGaVFHWI4Kxh_g0trBPlqBUJheTyZdqaE", 1445005647, 1812695346),
}

api_url = "http://107.174.205.248:5000/"
date_format = "%d-%m-%Y %H:%M:%S"

all_servers = ('primera', 'secura', 'suna', 'alpha', 'luxia', 'mira', 'oria')
