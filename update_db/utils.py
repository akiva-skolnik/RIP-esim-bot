...
from Utils.constants import countries_per_id, countries_per_server
...
def extract_player_details(player_profile_link: str, tree: fromstring) -> dict:
    ...
    try:
        ...
        citizenship = tree.xpath('//*[@class="profile-row newProfileRow" and span = "Citizenship"]/span/span/text()')[0]
